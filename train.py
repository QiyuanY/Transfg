...
class AverageMeter(object):
    """Computes and stores the average and current valuepython"""
    def __init__(self):
        self.reset()
...
def setup(args):
    ...
    if np.load(args.pretrained_dir):
        print(111)
...
def main():
    ...
    parser.add_argument('--data_root', type=str, default=r'D:\Python\TransFG-master\CUB_200_2011')
    ...
    parser.add_argument("--pretrained_dir", type=str, default=r'D:\Python\TransFG-master\pre_model\imagenet21k_ViT-B_16.npz',
                        help="Where to search for pretrained ViT models.")
